...
public class OperatorSignalException extends Exception
{

    private String mens;

    public OperatorSignalException(String s)
    {
        super(s);
        mens = "";
        mens = s;
    ...
    public OperatorSignalException()
    {
        mens = "";
        mens = "";
    }
    ...
    {
        return "Operator Signal Exception: " + mens;
    }
}
